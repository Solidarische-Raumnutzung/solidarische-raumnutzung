...
\must{11}{Es könnte einen Quick-checkin-button geben, welcher eine vorausgefüllte Terminerstellung öffnet. Dieser bietet auch eine alternative zur Interaktion mit dem Kalender.}
\must{11}{Es könnte einen Quick-checkout-button geben, welcher erfrühtes beenden eines Termines ermöglicht.}
