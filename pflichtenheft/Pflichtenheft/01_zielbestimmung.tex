...
\must{7}{Die Termin Ansicht muss die möglichkeit bieten, genauere Information über ein Termin darzustellen.}
...
\must{17}{Die Anwendung muss in der Lage sein, Benutzer die den Raum haben wollten, sollte der Raum doch wieder frei werden, über den freigewordenen Raum zu informieren.}
\must{18}{Die Anwendung muss den Raumstatus möglichst unkompliziert darstellen können. Es muss also sowohl die aktuelle Belegegung als auch die Priorität (bspw. durch eine farbigen Banner angezeigt werden) ohne eingeloggt zu sein, zu sehen.}
