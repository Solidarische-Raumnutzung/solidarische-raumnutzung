...
\must{18}{Die Nutzer*innen-Ansicht muss den Admins die Möglichkeit bieten, Konten zu löschen sowie die Anmeldung per Gastkonto zu deaktivieren.}
\must{19}{Admins müssen in der Termin-Ansicht Termine löschen und die Öffnungszeiten einstellen können.}
\must{20}{Es muss einen farbcodierten Banner geben, der den aktuellen Status des Raumes anzeigt.}
...
\wish{9}{Es könnte in Hardware einen Panik-Button}
