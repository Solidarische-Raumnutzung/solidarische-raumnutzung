...
\must{7}{Die Kalender-Ansicht muss die Termine des angemeldeten Nutzenden hervorgehoben darstellen.}
...
\must{18}{Die Kontolistenansicht muss den Admins die Möglichkeit bieten, einzelne Konten sowie die Anmeldung per Gastkonto zu deaktivieren.}
\must{19}{Admins müssen in der Termin-Ansicht Termine löschen können.}
\must{20}{Es muss ein farbcodiertes Banner geben, der den aktuellen Status des Raumes anzeigt.}
\must{21}{Admins müssen in der Kalender-Ansicht die Öffnungszeiten einstellen können}


\section{Wunschkriterien}\label{sec:wunschkriterien}

\wish{1}{Es könnte die Möglichkeit geben, mehr als einen Raum zur Buchung anzubieten. Dabei könnte eine Raumauswahl vor der Kalender-Ansicht die verschiedenen Möglichkeiten präsentieren. Existiert nur ein Raum, wird diese Auswahl übersprungen.}
