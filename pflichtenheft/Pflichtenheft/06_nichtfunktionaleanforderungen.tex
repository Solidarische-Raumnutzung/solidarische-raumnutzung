...
\notfunctional{4}{Es soll entsprechend auf Acessibility geachtet werden.} \unsure{Specify more concretly!}
\notfunctional{4}{Die UI soll in verschiedenen Sprachen dargestellt werden können, insbesondere Deutsch und Englisch.}
\notfunctional{4}{x}
