...
\todo[inline]{Haben wir ein Mockup für die Buchungsansicht (Dialog mit Beschreibung, Löschen, Kontaktieren?)}
\todo[inline]{Suche nach Buchungen scheint mir nicht sinnvoll, vorallem wenn wir vergangene Buchungen anonymisieren.}
