...
Die Termine in dieser Ansicht werden, anders als in der Kalenderansicht, in Form einer sortierten Liste dargestellt.
...
Außerdem können Nutzende die Termin-Ansicht (\ref{fig:calendarviewbooking}) zu einem Termin öffnen, indem sie auf den Termin klicken.
