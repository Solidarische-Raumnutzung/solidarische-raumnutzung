...
\newglossaryentry{SSR}{name=SSR, description={(Server-Side Rendering) Methode um das HTML einer Website auf dem Server zu produzieren, anstelle des Browsers}}
...
\unsure{OIDC ist nirgends im Text verwendet}
