...
\begin{itemize}
    \item Benutzerdaten (dauerhaft gespeichert) \unsure{Löschen wir Benutzer automatisch nach einer Weile?}
    \begin{itemize}
        \item Benutzername (oder \textit{Anonym} für anonyme Benutzer)
        \item (optional) E-Mail-Adresse
        \item OAuth- oder Cookie-Token
        \item Blockierungsstatus (wahr oder falsch) \unsure{Machen wir das?}
    \end{itemize}
