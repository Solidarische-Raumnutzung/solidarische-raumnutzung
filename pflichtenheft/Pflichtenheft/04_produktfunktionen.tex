...
\section{Unangemeldete Benutzer funktionen}\label{sec:unangemeldete-benutzer-funktionen}
\unsure{irgendwie sollten wir unter den funktionen noch klarstellen, wer welche funktionen Benutzen darf, dachte das wäre am elegantesten, andere/bessere Vorschläge sind auch wilkommen}
\begin{table}[htbp]
    \centering
...
\section{Angemeldete Benutzer funktionen}\label{sec:angemeldete-benutzer-funktionen}
\begin{table}[htbp]
    \centering
%    \caption{Überblick von allen Funktionen.}
    \begin{tabularx}{\textwidth}{ l|X|l }
...
\section{Admin funktionen}\label{sec:adminfunktionen}
