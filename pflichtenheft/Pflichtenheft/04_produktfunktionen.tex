...
\todo{These functions are still needed: (alle ansichten), (Terminkonflikte auflösen), (Admin fkt.: deaktivierung von Gastkontos, termine löschen)}
...
%    \caption{Überblick von allen Funktionen.}
    \begin{tabularx}{\textwidth}{ l|X|>{\raggedright\arraybackslash}X  }
        ...
        \ref{F110} & Anmelden als Admin &~\ref{MK18} \\
    \end{tabularx}
